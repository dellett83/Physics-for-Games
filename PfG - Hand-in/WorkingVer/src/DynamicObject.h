...
public:
	...
	*/
	...
	void addCollisionPlane(const CollisionPlane& plane) { collisionPlanes.push_back(plane); }
	...
	//rotation
	void rotate(const glm::vec3& angularDisplacement);
	glm::vec3 getAngularVelocity() const { return _angular_velocity; }
